...
namespace LeaveManagmentWeb.Controllers
{
    ...
    public class LeaveRequestsController : Controller
    {
        ...
        public async Task<IActionResult> ApproveRequest(int id, bool approve)
        {
            try
            {
                await leaveRequestRepository.ChangeApprovalStatus(id, approve);
            }
            catch(Exception ex)
            {
                throw;
        ...
        public async Task<IActionResult> Create(LeaveRequestsCreateVM model)
        {
            ...
            {
                ModelState.AddModelError(string.Empty, "An error has ocurred. Please try again.");
            }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("StartDate,EndDate,LeaveTypeId,DateRequested,RequestComments,Approved,Cancelled,RequestEmployeeId,Id,DateCreated,DateModified")] LeaveRequest leaveRequest)
        {
